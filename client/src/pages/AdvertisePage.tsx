...
const adTypes = [
  { value: 'large_banner', label: 'Advertisement Space', description: '160x600 banner ads positioned alongside content ($300/month)' },
];
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-16">
          ...
          <div className="flex justify-center mb-12">
            {/* Advertisement Space */}
            <Card className="p-6 hover:shadow-lg transition-shadow max-w-md border-2 border-gray-200">
              <div className="text-center">
                ...
                <h3 className="font-bold text-lg mb-2 text-gray-700">Advertisement Space</h3>
                <p className="text-sm text-gray-600 mb-4">
                  Strategic advertisement banners positioned alongside content on both sides of pages. Ideal for maximum visibility and engagement.
                </p>
                <div className="space-y-2 text-xs text-gray-500">
                  <div>• Size: 160×600px</div>
                  <div>• Position: Left & Right Sides</div>
                  ...
                  {adTypes.map((type) => (
                    <div key={type.value} className="border rounded-lg p-4">
                      <div className="flex items-start space-x-3">
                        <Star className="h-6 w-6 text-gray-600 mt-1" />
                        <div>
